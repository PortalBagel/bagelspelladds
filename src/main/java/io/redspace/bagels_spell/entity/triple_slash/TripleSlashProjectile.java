...
public class TripleSlashProjectile extends Projectile implements AntiMagicSusceptible {
    private static final EntityDataAccessor<Float> DATA_RADIUS = SynchedEntityData.defineId(TripleSlashProjectile.class, EntityDataSerializers.FLOAT);
    ...
    public TripleSlashProjectile(EntityType<? extends TripleSlashProjectile> entityType, Level level) {
    ...
    public TripleSlashProjectile(EntityType<? extends TripleSlashProjectile> entityType, Level levelIn, LivingEntity shooter) {
    ...
    public TripleSlashProjectile(Level levelIn, LivingEntity shooter) {
        this(PbEntityRegistry.TRIPLE_SLASH_PROJECTILE.get(), levelIn, shooter);
    }
    ...
    private void damageEntity(Entity entity) {
        if (!victims.contains(entity)) {
            DamageSources.applyDamage(entity, damage, PbSpellRegistry.TRIPLE_SLASH_SPELL.get().getDamageSource(this, getOwner()));
            victims.add(entity);
