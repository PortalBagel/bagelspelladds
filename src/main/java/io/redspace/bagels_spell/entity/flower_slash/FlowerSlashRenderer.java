...
//import io.redspace.ironsspellbooks.entity.spells.blood_slash.FlowerSlashProjectile;
...
public class FlowerSlashRenderer extends EntityRenderer<FlowerSlashProjectile> {
    ...
    public FlowerSlashRenderer(Context context) {
        super(context);
    }

    @Override
    public void render(FlowerSlashProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    private void drawSlash(Pose pose, FlowerSlashProjectile entity, MultiBufferSource bufferSource, int light, float width, int offset) {
        Matrix4f poseMatrix = pose.pose();
        Matrix3f normalMatrix = pose.normal();
    ...
    @Override
    public ResourceLocation getTextureLocation(FlowerSlashProjectile entity) {
    ...
    private ResourceLocation getTextureLocation(FlowerSlashProjectile entity, int offset) {
