package io.redspace.bagels_spell.entity.flower_evade;
...
public class FlowerEvadeProjectile extends Projectile implements AntiMagicSusceptible {
    private static final EntityDataAccessor<Float> DATA_RADIUS = SynchedEntityData.defineId(FlowerEvadeProjectile.class, EntityDataSerializers.FLOAT);
    private static final double SPEED = 0.2d;
    private static final int EXPIRE_TIME = 1 * 5;
    ...
    public FlowerEvadeProjectile(EntityType<? extends FlowerEvadeProjectile> entityType, Level level) {
    ...
    public FlowerEvadeProjectile(EntityType<? extends FlowerEvadeProjectile> entityType, Level levelIn, LivingEntity shooter) {
    ...
    public FlowerEvadeProjectile(Level levelIn, LivingEntity shooter) {
        this(PbEntityRegistry.FLOWER_EVADE_PROJECTILE.get(), levelIn, shooter);
    }
    ...
    private void damageEntity(Entity entity) {
        if (!victims.contains(entity)) {
            DamageSources.applyDamage(entity, damage, PbSpellRegistry.FLOWER_EVADE_SPELL.get().getDamageSource(this, getOwner()));
            victims.add(entity);
        }
    }
