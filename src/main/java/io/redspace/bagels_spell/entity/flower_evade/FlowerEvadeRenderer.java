...
public class FlowerEvadeRenderer extends EntityRenderer<FlowerEvadeProjectile> {
    ...
    public FlowerEvadeRenderer(Context context) {
        super(context);
    }

    @Override
    public void render(FlowerEvadeProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    private void drawSlash(Pose pose, FlowerEvadeProjectile entity, MultiBufferSource bufferSource, int light, float width, int offset) {
        Matrix4f poseMatrix = pose.pose();
        Matrix3f normalMatrix = pose.normal();
    ...
    @Override
    public ResourceLocation getTextureLocation(FlowerEvadeProjectile entity) {
    ...
    private ResourceLocation getTextureLocation(FlowerEvadeProjectile entity, int offset) {
