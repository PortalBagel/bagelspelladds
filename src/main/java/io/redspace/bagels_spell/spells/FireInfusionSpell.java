...
@AutoSpellConfig
public class FireInfusionSpell extends AbstractSpell {
    private final ResourceLocation spellId = new ResourceLocation(BagelsSpell.MODID, "fire_infusion");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        entity.addEffect(new MobEffectInstance(ExampleMobEffectRegistry.FIREINFUSED.get(), (int) (getSpellPower(spellLevel, entity) * 20), spellLevel - 1, false, false, true));


        if (entity instanceof ServerPlayer player) {
            player.getPersistentData().putInt("FireAttackDuration", (int) (getSpellPower(spellLevel, entity) * 20));
        }
